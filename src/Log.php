...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  {
      return constant('Log::'.$level);
  } // end public static function level */
   ...
   * @return  void
   */
  public static function start($file, $Line , $method , $params = [] , $level = 'debug')
  {
   ...
   * @return  void
   */
  public static function startVerbose($file, $Line , $method , $params = [])
  {
   ...
   * @return  void
   */
  public static function startDeprecated($file, $Line , $method , $params = [])
  {
   ...
   * @return  void
   */
  public static function startDummy($file, $Line , $method , $params = [])
  {
   ...
   * @return  void
   */
  public static function startOverride($file, $Line , $method , $params = [])
  {
