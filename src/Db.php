...
class Db
{
    ...
    */
    ...
    const ROLE_CREATE = 'm_role_created';

    const TIME_CHANGED = 'm_time_changed';

    const ROLE_CHANGE = 'm_role_changed';
...
/*////////////////////////////////////////////////////////////////////////////*/
    ...
    public static function connectDb($key, $connectionConf = null, $activ = false)
    {
        ...
        if (BuizCore::classLoadable($classname)) {
            ...
            throw new LibDb_Exception(
                'tried to load nonexisting database connection '.$classname
            );
        }
    ...
    public static function getLoggerConnection($key, $connectionConf = null)
    {
        ...
        if (BuizCore::classLoadable($classname)) {
            ...
            throw new LibDb_Exception('tried to load nonexisting database connection '.$classname);
        }
