...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @param $def boolean
   */
  public function __construct($conf = [] , $def = false)
  {
   ...
   *
   */
  public function setLangByConf($conf = [] , $def = false)
  {
    ...
    $this->lang = Conf::status('activ_language');
    //$this->lPackage = $conf['lang_path'];
    
    if (!isset($conf[$this->lang])) {
        $this->lang = 'de';
    }
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function loadCache()
  {
    ...
    $keyPath = str_replace('.' , '/' , BuizCore::$indexKey  );
    $file = PATH_GW.'cache/i18n/'.$this->lang.'/'.$keyPath.'/'.BuizCore::$indexKey.'.php';
  ...
  ('.NL;
    ...
    $file = $path.BuizCore::$indexKey.'.php';
...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @return string
   */
  public function l($text, $key, $data = [])
  {
...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @return string
   */
  public function time2($time = null)
  {
    return date($this->timeFormat2, strtotime($time));
  }//end public function time2 */
