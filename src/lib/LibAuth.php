...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function login($username = null, $password = null)
  {
    ...
    if (is_null($username)) {
      ...
      if (!BuizCore::classExists($authClass)) {
    ...
    if (!BuizCore::classExists($verificationClass)) {
  ...
  public function verificate($username, $password, $noPasswd = false)
  {
    ...
    $verifivated = $verification->verificate($username , $password);

    if (!$verifivated) {
        $this->getResponse()->addError('Invalid access for user '.$username);
    }
