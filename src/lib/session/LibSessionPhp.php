...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @return void
   */
  public function start($name = null, $sessionId = null , $sessionSavePath = null)
  {
    ...
    if ($sessionSavePath) {
        ...
        if(!$this->sessionSavePath){
            $this->sessionSavePath = PATH_GW.'tmp/session/';
        }
    }
    ...
    if (!is_null($this->sessionSavePath)) {
