...
class SDate
{
   ...
   * @var array $weeks
   */
  public static function getFilteredMonthDays($year, $month, $days = [], $weeks = [])
  {
    ...
    * @return string
    */
    public static function getTimespanInDays($start, $end)
    {
    ...
    }//end public static function getTimespanInDays */
