...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  */
   ...
   *
   */
  public static function checkFormInput($values , $messages, $subkey = null , $rules = [] , $rulesMessages = [])
  {
   ...
   *
   */
  public static function checkSearchInput($values , $messages, $subkey = null , $rules = [] , $rulesMessages = [])
  {
   ...
   *
   */
  public static function checkMultiFormInput($values , $messages, $subkey = null , $rules = [] , $rulesMessages = [])
  {
   ...
   *
   */
  public static function checkMultiInputLang($values , $messages, $subkey = null , $rules = [] , $rulesMessages = [])
  {
