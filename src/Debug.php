...
CODE;
    ...
    foreach ($traces as $key => $value) {
      ...
      /*
        'file' => string '/var/www/WorkspaceBuizCore/BuizCore/src/lib/LibTemplate.php' (length=74)
        'line' => int 1005
  ...
  public static function consoleHtml()
  {
    ...
    if (DEBUG) {
      $renderDur = BuizCore::getDuration(BuizCore::$scriptStart);
      $html .= '<h3>Render Duration: '.$renderDur.'</h3>';
      ++$time;

      $renderDur = BuizCore::$env->getDb()->queryTime;
