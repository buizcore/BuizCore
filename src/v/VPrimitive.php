...
class VPrimitive extends V_Adaper
{
     ...
     * @param array $constr
     */
    public function isInt($value, array $constr = []  )
    {
     ...
     * @param array $constr
     */
    public function isSmallint($value, array $constr = []  )
    {
     ...
     * @param array $constr
     */
    public function isBigInt($value, array $constr = [])
    {
     ...
     * @param array $constr
     */
    public function isEid($value, array $constr = [])
    {
        $this->clean();
        $this->origVal = $value;
     ...
     * @param array $constr
     */
    public function isNumeric($value, array $constr = [])
    {
     ...
     * @param array $constr
     */
    public function isBoolean($value, array $constr = [])
    {
     ...
     * @param array $constr
     */
    public function isBoolean3($value, array $constr = [])
    {
        $this->clean();
        $this->origVal = $value;
     ...
     * @param int $minSize
     */
    public function isText($value, array $constr = [])
    {
