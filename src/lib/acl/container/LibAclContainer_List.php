...
/* //////////////////////////////////////////////////////////////////////////// */
     ...
     */
    public function __construct($env, $level = null, $refBaseLevel = null)
    {
...
/* //////////////////////////////////////////////////////////////////////////// */
     ...
     *            die relevanten Rollen
     */
    public function loadEntryExplicitRoles($area, $ids, $roles = [])
    {
     ...
     *            die relevanten Rollen
     */
    public function loadNumExplicitUsers($area, $ids, $roles = [])
    {
    ...
    public function loadDefault($params, $entity = null)
    {
        ...
        foreach ($backPaths as $backPath) {
            ...
            $hasRole = $acl->hasRoleSomewhere($pathRoles, $backPath['target_area_key']);
        ...
        if ($params->isAclRoot) {
            ...
            $acl->injectDsetRoles($this, $this->aclAreas, $entity);
            ...
            $acl->injectDsetPathPermission($this, // sich selbst als container mit übergeben
$params->aclRoot, $params->aclRootId, $params->aclLevel, $params->aclKey, $params->refId, $params->aclNode, $entity, $this->loadReferences) // rechte für die referenzen mitladen
;
        }
