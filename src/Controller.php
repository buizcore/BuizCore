...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function loadModel($modelKey, $key = null, $injectKeys = [])
  {
    ...
    if (!isset($this->models[$key]  )) {
      ...
      } elseif (BuizCore::classExists($modelNameOld)) {
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function run($action = null)
  {
    ...
    if ($this->modelName) {
      ...
      if (!$this->model && BuizCore::classExists($modelClass))
           ...
           if (isset($this->options[$methodeKey])) {
             ...
             if(
              ...
              throw new InvalidRequest_Exception(
                $response->i18n->l(
                  'The request method {@method@} in {@mky@} is not allowed for this action! Use {@use@}.',
                  'wbf.message',
                  array(
             ...
             if(
               ...
               throw new InvalidRequest_Exception(
                 $response->i18n->l(
                   'Invalid format {@type@}, for service {@service@} valid formats are: {@use@}',
                   'wbf.message',
                   array(
  ...
  public function login()
  {
    ...
    if ($loggedIn) {
      ...
      try {
        ...
        $authRole = $orm->get('WbfsysRoleUser', "lower(name) = lower('{$userName}')");
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function loadUi($uiName , $key = null)
  {
    ...
    if (!isset($this->uis[$key]  )) {
      ...
      } elseif (BuizCore::classExists($oldClassName)) {
