  ...
  */
  public function server($key = null , $validator = null, $message = null)
  {
    ...
    if ($validator) {
      ...
      if (isset($_SERVER[$key])) {
        $fMethod = 'add'.ucfirst($validator);
        $filter->$fMethod($key, $_SERVER[$key]);
...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   *
   */
  public function checkFormInput($values , $messages, $subkey = null, $required = [], $state = null)
  {
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  */
  ...
  public function validateFormData(
  ...
  }//end public function validateFormData */
    ...
    */
    public function validateInsert($entity, $keyName, $fields = [], $required = [], $state = null)
    {
        ...
        return $this->validate($entity, $keyName, $fields, $required, $state);
   ...
   * @param array $required
   */
  public function validateMultiUpdate($entityName, $keyName, $fields = [], $required = [])
  {
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dumpAsJson()
  {
    ...
    $requestData['data'] = isset($_POST)?$_POST:[];
