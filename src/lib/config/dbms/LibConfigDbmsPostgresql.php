...
# buildservice can connect from outside
host    all         buildservice         0.0.0.0/0    md5

# admin can connect from outside
host    all         admin                0.0.0.0/0    md5

# IPv4 local connections: user need a valid account
...
# "local" is for Unix domain socket connections only, user need a valid account
local   all         all                               md5
