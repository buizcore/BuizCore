...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function __construct($get, $post, $cookie = [], $files= [], $server= [], $env= [])
  {
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  */
   ...
   *
   */
  public function checkFormInput($values , $messages, $subkey = null , $rules = [], $ruleMessages = [])
  {

    $sys = BuizCore::getActive();
   ...
   *
   */
  public function checkSearchInput($values , $messages, $subkey = null , $rules = [], $ruleMessages = [])
  {
   ...
   *
   */
  public function checkMultiFormInput($values , $messages, $subkey = null , $rules = [] , $ruleMessages = [])
  {
   ...
   *
   */
  public function checkMultiInputLang($values , $messages, $subkey = null , $rules = [] , $ruleMessages = [])
  {
    ...
    foreach ($this->post[$subkey] as $id => $row) {
      ...
      foreach ($filtr as $key => $tmpVal) {
        ...
        if ($key != BUIZ_DB_KEY && $key != 'id_lang' && trim($tmpVal) != '') {
          $isEmpty = false;
          break;
        }
      }
