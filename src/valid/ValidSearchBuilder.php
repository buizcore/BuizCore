...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function validate($searchCol, $fieldData)
  {
    ...
    $type = isset($fieldData['type'])?$fieldData['type']:strtolower($fieldData[1]);
    ...
    $searchCol['con'] = isset($searchCol['con'])?(boolean)$searchCol['con']:true;
    $searchCol['not'] = isset($searchCol['not'])?(boolean)$searchCol['not']:false;
